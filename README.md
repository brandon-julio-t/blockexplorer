...
- [x] Allow users to click on a block listed in the webpage to get the block's details including its list of transactions
- [x] From the list of transactions allow users to click on specific transactions to get the details of the transaction
- [x] Make an accounts page where a user can look up their balance or someone else's balance
